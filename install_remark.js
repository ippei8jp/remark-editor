...
const target_url = 'https://github.com/gnab/remark/archive/v0.14.0.zip';
const tmp_dir    = 'download';
const tmp_file   = `${tmp_dir}/remark.zip`;
const dist_dir   = 'src/remark';
const extract_target   = 'remark-0.14.0/out/';
